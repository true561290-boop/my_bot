...
# --- قائمة قضايا التحقيق الجنائي (أكثر من 50 قضية قصيرة) ---
CASES = [
    {
        "q": "عُثر على رجل ميت في مكتبه بيده مسدس والتسجيل الصوتي على الطاولة يقول: 'لا أستطيع الاستمرار، وداعاً'. اضغط زر التشغيل ثم تسمع طلقة. عرف المحقق فوراً أنها جريمة قتل وليست انتحار. كيف عرف ذلك؟",
        "a": ["من أرجع الشريط", "من الذي أعاد الشريط", "أعاد الشريط", "اعاد الشريط", "رجوع الشريط", "مين اعاد الشريط", "من اعاد الشريط"]
    },
    {
        "q": "رجل يعيش في الطابق الـ 10، كل يوم يأخذ المصعد للطابق 7 ثم يكمل باقي الطوابق مشياً على الأقدام، إلا في الأيام الممطرة يأخذ المصعد مباشرة للطابق 10. لماذا؟",
        "a": ["قصير", "إنسان قصير", "انسان قصير", "انه قصير", "لأنه قصير", "لانه قصير", "قصير القامة", "طوله قصير"]
    },
    {
        "q": "توفيت امرأة في حادث سيارة، وادعى زوجها أنه لم يكن معها. وعندما فحص المحقق هاتف الزوج وجد أنه يحوي حجز تذكرتي طيران للذهاب فقط وحجز واحدة للعودة. كيف كشف ذلك؟",
        "a": ["حجز تذكرة عودة واحدة", "تذكرة عودة واحدة", "حجز تذكرة واحدة للعودة", "تذكره واحده للعوده"]
    },
    {
        "q": "وجد رجل مقتولاً يوم الأحد. السائق قال إنه كان يغسل السيارة، الخادمة قالت إنها كانت تجلب البريد، والطباخ قال إنه يحضر الغداء. اعتقل المحقق القاتل فوراً. من القاتل؟",
        "a": ["الخادمة", "الخادمه", "خادمة", "خادمه"] # لا يوجد بريد يوم الأحد
    },
    {
        "q": "سرق أحد الأشخاص المظلة الملكية. المشتبه بهم 3: الأول قال كنت تحت المطر ولم أبتل، الثاني قال كنت أقرأ، الثالث قال كنت أستحم. من السارق؟",
        "a": ["الأول", "الاول", "الشخص الأول", "الشخص الاول"]
    },
    {
        "q": "وجد رجل ميت في غرفته المغلقة تماماً من الداخل، وبجانبه بركة ماء صغيرة ومشنوق في السقف بدون أي كرسي أو طاولة بالأسفل. كيف شنق نفسه؟",
        "a": ["قالب ثلج", "على ثلج", "وقوفه على الثلج", "ثلج", "قالب الثلج", "كان واقفا على ثلج"]
    },
    {
        "q": "دخل طبيب وممرض لغرفة المريض. المريض قال: أخي ليس طبيباً، والطبيب قال: أنا ليس لدي إخوة! من يكون الطبيب بالنسبة للمريض؟",
        "a": ["أخته", "اخت", "أخت", "اخته"]
    },
    {
        "q": "في يوم مثلج، ادعى صاحب المنزل أن جارته سرقت خاتمه الذهب. الجارة قالت: لم أخرج من منزلي بسبب أثري على الثلج. لكن المحقق وجد آثار أقدام راجعة فقط نحو منزلها ولم يجد آثاراً ذاهبة! كيف سرقته؟",
        "a": ["مشيت للورا", "مشيت إلى الخلف", "مشيت للback", "مشيت للورا", "مشيت بالمقلوب", "مشيت بالعكس"]
    },
    {
        "q": "دخل لص متجراً وقتل التاجر واستولى على الأموال، وعندما خرج لم تكن هناك أي بصمات على القفل ولا الكاسيت، ورغم ذلك لم يكن يرتدي قفازات! كيف؟",
        "a": ["كان يرتدي القفازات في يديه قبل أن ينزعها", "لم يلمس شيء", "لم يلمس شيئاً", "استخدم منديل", "لم يلمس القفل"]
    },
    {
        "q": "عثر على جثة رجل سقط من شباك بناية عالية. المحقق ذهب للدور الأول فتح الشباك ورمى عملة، ثم الدور الثاني بنفس الشيء وهكذا. استنتج أن الرجل قُتل ولم ينقذ نفسه. كيف؟",
        "a": ["جميع النوافذ كانت مغلقة", "النوافذ مغلقة", "النوافذ كانت مغلقة", "الشباك كان مغلق", "الشبابيك مغلقة"]
    },
    {
        "q": "ادعى رجل أنه تعرض للسرقة في منتصف الليل أثناء انقطاع الكهرباء، وقال إنه رأى وجه السارق بوضوح بفضل ضوء البرق الذي أضاء الغرفة لثانية. المحقق لم يصدقه، لماذا؟",
        "a": ["ضوء البرق لا يسمح برؤية التفاصيل بوضوح", "البرق يعمي العين مؤقتا", "البرق يسبب العمى المؤقت", "البرق خاطف ولا يوضح الملامح"]
    },
    {
        "q": "وجد رجل مقتول في الصحراء وبجانبه حقيبة مغلقة لم تفتح. لو فُتحت هذه الحقيبة لكان الحفاظ على حياته ممكناً! ما هذه الحقيبة؟",
        "a": ["المظلة", "مظلة الهبوط", "الباراشوت", "باراشوت", "مظله"]
    },
    {
        "q": "سرقت لوحة ثمينة في منتصف الليل. المشتبه به قال: كنت نائماً طوال الليل ولم أفتح عيني إطلاقاً. المحقق علم أنه يكذب فوراً، لماذا؟",
        "a": ["كيف عرف أن اللوحة سرقت في منتصف الليل", "عرف وقت السرقة", "حدد الوقت"]
    },
    {
        "q": "رجل مات بالسم بعد أن شرب هو وصديقه من نفس الكأس ونفس العصير بنفس الكمية، لكن الصديق لم يمت! كيف ذلك؟",
        "a": ["السم كان في الثلج", "في الثلج", "السم بالثلج", "ثلج"]
    },
    {
        "q": "حضر رجل إلى الشرطة وقال إن زوجته قفزت من الجبل أثناء التقاط صورة. الضابط قبض عليه بتهمة القتل بناءً على مكالمة لمكتب السفريات. ماذا اكتشف الضابط؟",
        "a": ["حجز تذكرة ذهاب فقط لزوجته", "تذكرة ذهاب فقط للزوجة", "حجز تذكرة واحدة للعودة"]
    },
    {
        "q": "وقعت جريمة سرقة في منزل غني. القاتل ترك رسالة مكتوبة بالدماء تقول: 'سأعود'. لكن المحقق عرف أن الرسالة كتبها صاحب المنزل قبل وفاته وليس السارق. كيف؟",
        "a": ["الخط يد صاحب المنزل", "بصمات الضحية على القلم", "الدماء دمه هو"]
    },
    {
        "q": "وجد شرطي جثة رجل مقتولاً برصاصة في الرأس داخل سيارته. جميع الأبواب والنوافذ كانت مغلقة ومقفولة تماماً، ولا توجد ثقوب في الزجاج والمسدس بالخارج. كيف قُتل؟",
        "a": ["السيارة كابريوليه مفتوحة السقف", "سقف السيارة مفتوح", "سيارة مكشوفة", "السقف مفتوح"]
    },
    {
        "q": "امرأة أطلقت النار على زوجها، ثم غمرته تحت الماء لمدة 5 دقائق، ثم علقته. بعد ساعة ذهبا معاً لتناول العشاء في مطعم! كيف حدث هذا؟",
        "a": ["مصورة", "كانت تصوره", "الصورة", "مصورة فوتوغرافية", "كانت تطبع الصورة"]
    },
    {
        "q": "رجل وُجد مقتولاً داخل مكتبه وأمامه كتاب مفتوح على الصفحة 45 و46. المحقق لاحظ شيئاً غريباً وأكد أن المكان تم ترتيبه. ما هو الغريب؟",
        "a": ["الصفحتان 45 و 46 على وجه واحد", "صفحة واحدة", "45 و 46 في ورقة واحدة", "وجه وظهر"]
    },
    {
        "q": "ادعى رجل أن سارقاً دخل بيته وكسر زجاج النافذة من الخارج ودخل. عند المعاينة قبض المحقق على صاحب البيت! كيف عرف كذبه؟",
        "a": ["الزجاج المتناثر كان بالخارج", "الزجاج بالخارج", "بقايا الزجاج سقطت في الخارج"]
    },
    {
        "q": "جريمة قتل في يوم شديد البرودة والتجمد. المتهم قال: كنت أقف عند النافذة وأشاهد الشارع عبر زجاج النافذة الدافئ. قبض عليه المحقق فوراً، لماذا؟",
        "a": ["الزجاج يتكثف عليه بخار الماء في البرد", "الزجاج يتعتم من البخار", "يتكون عليه البخار"]
    },
    {
        "q": "عثر على رسام مقتولاً في مرسمه. كانت الجثة مغطاة بألوان زيتية أحمر وأصفر وأزرق، والفرشاة بيده. المحقق قال هذه ليست جريمة قتل بل انتحار بجرعة زائدة! ما السير؟",
        "a": ["لا توجد آثار صراع", "الفرشاة بيده ولم تسقط", "لوحته أظهرت ذلك"]
    },
    {
        "q": "رجل مات بقطع في الشريان الرئيسي ويده اليمنى ممسكة بالسكين، لكن المحقق أثبت فوراً أنه قُتل. كيف عرف ذلك؟",
        "a": ["الرجل أعسر", "كان يستخدم يده اليسرى", "هو أعسر", "اعسر"]
    },
    {
        "q": "سرقت ماسة نادرة من معرض. هناك 3 مشتبهين: سائق سائح، وطبيب، وطفل. السائق قال: كنت أغير زيت السيارة. الطبيب قال: كنت أباشر مريضاً. الطفل قال: كنت ألعب بالخارج. كشف المحقق السارق فوراً من؟",
        "a": ["السائق", "سائق", "سائق السيارة"] # تغيير زيت السيارة يستغرق وقتاً ولا يتركك بدون آثار
    },
    {
        "q": "في الشتاء، وجد رجل مقتولاً في حديقته والثلج يغطي المكان. لم تكن هناك أي آثار أقدام حول الجثة إطلاقاً والقاتل استخدم سكيناً. كيف هرب القاتل دون ترك أثر؟",
        "a": ["استخدم سكين ثلج وذاب", "السكين مصنوعة من الثلج", "سكين من الثلج", "سكين ثلج"]
    },
    {
        "q": "سيدة أبلغت عن سرقة عقدها الماسي، وقالت إن السارق قفز من السور العالي للحديقة وهرب. المحقق وجد آثار أقدام عميقة جداً بالقرب من السور لكنه اتهما بالنصب! لماذا؟",
        "a": ["إذا قفز من الأعلى تكون الآثار عميقة عند الهبوط وليس الخروج", "الآثار لداخل المنزل وليس للشارع"]
    },
    {
        "q": "قتل رجل برصاصة في رأسه داخل شقته. جارته قالت: سمعت صراخاً ثم صوت طلقة واحدة ثم صمت. كشف المحقق كذبها فوراً، كيف؟",
        "a": ["صوت الرصاصة أسرع من الصراخ", "الصوت لا يتأخر", "طلقة الرصاص تسبق الصراخ"]
    },
    {
        "q": "وجدت جثة امرأة في الغابة مع وجود آثار إطارات سيارة بجانبها. قبض المحقق على الميكانيكي رغم أنه يملك سيارة متوقفة منذ شهور. كيف عرف؟",
        "a": ["نقشة الإطارات تطابق سيارته", "إطارات السيارة", "نوع الإطار"]
    },
    {
        "q": "رجل كان يقود سيارته في الليلة الظلماء بدون إضاءة المصابيح وبدون وجود قمر، وفي الطريق عبر شخص أسمر يرتدي أسود بالكامل، ومع ذلك توقف الرجل وتفاداه! كيف رآه؟",
        "a": ["كان الوقت نهاراً", "في النهار", "كان نهارا", "نهار"]
    },
    {
        "q": "مات رجل في غرفته وكان هناك أنبوب غاز مفتوح. تبين أن الرجل أصم وأبكم وأعمى. استنتج المحقق أن شخصاً آخر هو من فتح الغاز! كيف؟",
        "a": ["لأنه لا يشم أيضاً أو لم يستطع حماية نفسه", "الغاز تم فتحه من الخارج", "الأصم والأبكم والأعمى لا يستطيع فتح الغاز بنفسه معقد"]
    },
    {
        "q": "سرق مبلغ من البنك. خبير البصمات لم يجد أي بصمة على الخزنة المفتوحة مطلقاً رغم أنها تمسح يومياً. ماذا يعني هذا للمحقق؟",
        "a": ["السارق مسح البصمات", "تم مسح البصمات", "استخدم قفازات ومسحها"]
    },
    {
        "q": "شخص ادعى أن لصوصاً اقتحموا منزله وسرقوا ساعته الثمينة بعد أن هددوه بمسدس مائي! المحقق سجنه فوراً بتهمة البلاغ الكاذب. لماذا؟",
        "a": ["المسدس المائي لا يهدد الحياة", "المسدس المائي لعبة", "تهديد غير منطقي"]
    },
    {
        "q": "تم العثور على جثة رجل سقط من قمة جبل. الحبل الذي كان يتسلق به قُطع بنصل حاد. من أين عرف المحقق أنه قُتل؟",
        "a": ["الحبل مقطوع بنصل حاد وليس مقطوعاً بالتآكل", "الحبل مقطوع بفعل فاعل", "قطع حاد"]
    },
    {
        "q": "وجد رجل مقتولاً داخل حافلة متوقفة. السائق قال: لم يدخل أحد الحافلة طوال الليل وكنت أقف بجانب الباب الوحيد. المحقق قبض على السائق! لماذا؟",
        "a": ["لأنه الباب الوحيد وهو كان يراسبه", "السائق هو القاتل", "هو الوحيد هناك"]
    },
    {
        "q": "جريمة تسميم في مطعم. جميع الزبائن شربوا من نفس إبريق الشاي، ولكن شخصاً واحداً فقط مات. المحقق اكتشف أن التسمم لم يكن في الشاي! أين كان؟",
        "a": ["في الكوب", "في الكوب الخاص به", "في كوبه", "الكوب"]
    },
    {
        "q": "وجد رجل ميتاً على مكتبه بطلقة في رأسه. ورقة الانتحار كانت مكتوبة بالكمبيوتر ومطبوعة وموقعة بيده. المحقق أثبت أنها جريمة قتل! كيف؟",
        "a": ["المنتحر يكتب بيديه عادة وليس كمبيوتر", "التوقيع مزور", "ورقة مطبوعة"]
    },
    {
        "q": "سرقة في مستشفى. المشتبه به طبيب جراح. قال الطبيب: كنت أجري عملية جراحية استمرت 5 ساعات دون انقطاع. المحقق طلب رؤية تقرير العملية واكتشف كذبه! لماذا؟",
        "a": ["لا يوجد تقرير أو التوقيع مفقود", "زمن العملية في التقرير مختلف", "لم تكن هناك عملية"]
    },
    {
        "q": "رجل استيقظ ووجد زوجته ميتة بجانبه ومسمومة. قال إنه لم يشعر بشيء لأنه كان نائماً عميقاً بسبب حبوب المنوم. المحقق قبض عليه، لماذا؟",
        "a": ["كيف عرف أنها مسمومة دون تشريح", "عرف سبب الوفاة فوراً", "حدد الموت بالسم"]
    },
    {
        "q": "وجد شتات أوراق مالية محترقة في موقد شقة. المتهم قال: أحرقتها بالخطأ عندما أردت إشعال الشمعة. المحقق عرف أنه ألقاها عمداً! كيف؟",
        "a": ["النقود لا تحترق دفعة واحدة بالخطأ", "الورق تم تجميعه وحرقه عمداً"]
    },
    {
        "q": "شخص قُتل في سيارته بطلقة مسدس من المسافة صفر. لا توجد أي دماء على مقاعد السيارة إطلاقاً باستثناء ملابسه! المحقق عرف أن القاتل نقل الجثة للسيارة، كيف؟",
        "a": ["عدم وجود دماء على المقعد", "عدم تناثر الدماء داخل السيارة", "نقل الجثة"]
    },
    {
        "q": "قُتل رجل داخل متحف. الكاميرات أظهرت رجلاً يرتدي زي معطف أسود وقبعة. الشرطة فتشت المشتبه بهم ولم تجد المعطف! أين أخفاه؟",
        "a": ["ارتداه بالمقلوب", "قلب المعطف", "عكس لون المعطف"]
    },
    {
        "q": "رجل أبلغ أن شقيقه التوأم قتله شخص ما وحاول أخذ هويته. المحقق قبض على الأخ الباقي بتهمة قتل توأمه! كيف كشفه؟",
        "a": ["بصمات الأصابع مختلفة لدى التوأم", "البصمات", "بصمة الأصبع"]
    },
    {
        "q": "وجد رجل غريقاً في بحيرة ماء عذب، لكن الرئة كانت تحتوي على مياه مالحة! ماذا استنتج المحقق؟",
        "a": ["قُتل في البحر ونقل للبحيرة", "غرق في البحر", "مات في ماء مالح ثم أُلقي هنا"]
    },
    {
        "q": "سرق محل جوهرات. السارق أخذ الألماس وترك الذهب الخالص والفضة. المحقق استنتج أن السارق خبير! لماذا؟",
        "a": ["الألماس أسهل بالتهريب وأغلى خفيف الوزن", "خفيف الوزن وأغلى ثمنًا", "لص خبير"]
    },
    {
        "q": "تاجر أبلغ عن سرقة خزينته. الخزنة تفتح برقم سري مكون من 8 أرقام لا يعلمه إلا هو. لا توجد آثار كسر! من السارق؟",
        "a": ["التاجر نفسه", "التاجر", "صاحب الخزنة"]
    },
    {
        "q": "جثة رجل في صحراء، يرتدي ثياباً كاملة وحذاءً جديداً تماماً دون أي كدمات. مات من أسباب طبيعية لكن لا توجد أي آثار أقدام بالقرب منه! كيف وصل؟",
        "a": ["سقط من طائرة", "سقط من الطائرة", "رمي من طائرة"]
    },
    {
        "q": "امرأة ادعت أن زوجها سقط من الشرفة أثناء مسح الزجاج في المطر. المحقق قبض عليها فوراً، لماذا؟",
        "a": ["لا أحد يمسح الزجاج أثناء المطر", "تنظيف الزجاج في المطر غير منطقي", "تمسح الزجاج بالمطر"]
    },
    {
        "q": "سرقة في مكتبة. السارق سرق كتاباً واحداً فقط نادراً وترك بقية الكتب الثمينة. المحقق عرف أن السارق جامع كتب! لماذا؟",
        "a": ["سرق كتاباً محدد ونادر", "لأنه يعرف قيمة هذا الكتاب تحديداً", "لأنه خبير كتب"]
    },
    {
        "q": "رجل وجد ميتاً بجرعة زائدة من دواء. العلبة كانت فارغة تماماً وموضوعة بجانبه والنشرة الطبّية ممزقة. المحقق أكد أنها جريمة! كيف؟",
        "a": ["تمزيق النشرة لإخفاء الجرعة المسموحة", "إخفاء معلومات الدواء", "القاتل مزق النشرة"]
    },
    {
        "q": "وجد رجل مقتولاً في سفينة بالبحر. المشتبه بهم: القبطان، الطباخ، والمهندس. القبطان قال كان يوجه السفينة، الطباخ قال يقطع اللحم، والمهندس قال يغير زيت محرك السفينة المتوقفة! من القاتل؟",
        "a": ["المهندس", "مهندس", "مهندس السفينة"]
    },
    {
        "q": "جريمة سرقة هاتف. السارق اتصل بصاحب الهاتف بعد ساعة ليطلب فدية. المحقق حدد مكانه فوراً، كيف؟",
        "a": ["عن طريق تتبع شريحة الهاتف أو الـ GPS", "تتبع الموقع", "عبر الـ GPS", "تتبع المكالمة"]
    },
    {
        "q": "شخص قال إنه تعرض للهجوم من الخلف وضُرِب على رأسه بآلة حادة، لكن الفحص أظهر أن الكدمة في مقدمة الجبهة! ماذا استنتج المحقق؟",
        "a": ["يكذب", "ادعاء كاذب", "هو من ضرب نفسه", "بلاغ كاذب"]
    },
    {
        "q": "وجد رجل مقتولاً داخل مصعد بين الطابقين 3 و4. السلك كان مقطوعاً ولكن المصعد لم يسقط! كيف؟",
        "a": ["مكابح الطوارئ تعمل تلقائياً", "وجود نظام أمان بالمصعد", "المكابح الآلية"]
    },
    {
        "q": "امرأة قتلت زوجها ثم اتصلت بالشرطة وقالت: تعالوا فوراً، زوجي انتحر! عندما وصلوا وجدوا المسدس في يده اليسرى والطلقة بالجانب الأيسر، لكنهم اعتقلوها فوراً! لماذا؟",
        "a": ["الزوج يستخدم يده اليمنى", "لأنه أيمن", "الزوج ليس أعسر"]
    },
    {
        "q": "شخص وجد ميتاً في غرفته وكان هاتف الغرفة مرفوعاً عن السماعة. المحقق عرف أن القاتل هو آخر من اتصل به! كيف؟",
        "a": ["ترك السماعة مرفوعة يمنع استقبال اتصالات أخرى", "خدمة إعادة التتبع للمكالمة الأخيرة"]
    }
]
...
# --- أمر لعبة لغز (بديلة لعبة سجن وبنظام الجولات) ---
...
# --- أمر لعبة القضية (تحقيق الجرائم والقضايا) ---
@bot.command(name="قضية", aliases=["قضيه", "investigate", "case"])
@in_channel(GAMES_CHANNEL_ID)
async def case_game(ctx, rounds: int = 1):
    if rounds < 1 or rounds > 10:
        await ctx.send(
            "❌ يرجى تحديد عدد جولات بين **1** و **10** فقط", delete_after=3
        )
    ...
    for round_num in range(1, rounds + 1):
        case_data = random.choice(CASES)

        embed = discord.Embed(
            title=f"🔎 قضية جنائية - الجولة {round_num}",
            description=(
                f"يا أيها المحقق {ctx.author.mention}، حل القضيّة التالية لحصولك على **50**"
                f" طولار 💵:\n\n📜 **{case_data['q']}**"
            ),
            color=discord.Color.dark_purple(),
        )
        embed.set_footer(text="⏱️ لديك دقيقة ونصف (90 ثانية) لحل هذه القضية الجنائية")
        ...
        try:
            ...
            if any(ans.lower() in user_answer for ans in case_data["a"]):
                add_balance(ctx.author.id, 50)
                await ctx.send(
                    f"🎉 **تحقيق ناجح ومذهل!** حللت القضية وتم إضافة 50 طولار إلى حسابك يا"
                    f" {ctx.author.mention}",
                    allowed_mentions=discord.AllowedMentions(users=False),
                )
            else:
                await ctx.send(
                    f"❌ **استنتاج خاطئ!** التحليل الصحيح للقضية هو:\n**{case_data['a'][0]}**"
                )
        except asyncio.TimeoutError:
            await ctx.send(
                f"⏰ **انتهى الوقت!** لم تكتشف الحل في الوقت المحدد. التحليل الصحيح كان:\n**{case_data['a'][0]}**",
                allowed_mentions=discord.AllowedMentions(users=False),
            )
...
async def help_command(ctx):
    ...
    embed.add_field(
        ...
        value=(
            ...
            "• `.قضية [عدد الجولات]` : التحدي بحل القضايا الجنائية (1-10 جولات)\n"
