...
QUESTIONS = [
    ...
    {"q": "من هو الملقب بـ 'سيف الله المسلول'؟", "a": ["خالد بن الوليد", "خالد ابن الوليد"]},
    {"q": "ما هو أثقل كوكب في المجموعة الشمسية؟", "a": ["المشتري", "كوكب المشتري"]},
    {"q": "ما هو الغاز الأكثر وجوداً في الغلاف الجوي؟", "a": ["النيتروجين", "نيتروجين"]},
    ...
    {"q": "ما هو أصلح معركة حدثت في التاريخ الإسلامي وكانت فتحاً مبيناً؟", "a": ["فتح مكة"]},
    {"q": "من هو القائد المسلم الذي فتح الأندلس؟", "a": ["طارق بن زياد", "طارق ابن زياد"]},
    {"q": "ما هي عاصمة اليابان؟", "a": ["طوكيو"]},
    {"q": "ما هي الوحدة المستخدمة لقياس الشدة الصوتية؟", "a": ["ديسيبل", "الديسيبل"]},
    {"q": "ما هو الكوكب الملقب بالكوكب الأحمر؟", "a": ["المريخ", "كوكب المريخ"]},
    {"q": "ما هي عاصمة البرازيل؟", "a": ["برازيليا"]},
    {"q": "كم عدد قلوب الأخطبوط؟", "a": ["3", "ثلاثة", "٣"]},
    {"q": "من هو مخترع المصباح الكهربائي؟", "a": ["توماس أديسون", "اديسون", "أديسون"]},
    {"q": "ما هي أصغر عظمة في جسم الإنسان؟", "a": ["الركاب", "عظمة الركاب"]},
    {"q": "ما هي عاصمة فرنسا؟", "a": ["باريس"]},
    {"q": "في أي قارة تقع مصر؟", "a": ["أفريقيا", "افريقيا"]},
    {"q": "ما هو أكبر محيط في العالم؟", "a": ["المحيط الهادي", "المحيط الهادئ"]},
    {"q": "كم عدد أضلاع المثلث؟", "a": ["3", "ثلاثة", "٣"]},
    {"q": "ما هو المكون الرئيسي للزجاج؟", "a": ["الرمل", "الريمال"]},
    {"q": "ما هي عاصمة ألمانيا؟", "a": ["برلين"]},
    {"q": "من هو الشاعر الملقب بـ 'أمير الشعراء'؟", "a": ["أحمد شوقي", "احمد شوقي"]},
    ...
    {"q": "ما هو المكون الأساسي للشمس؟", "a": ["الهيدروجين", "غاز الهيدروجين"]},
    ...
    {"q": "ما هي المادة الأكثر صلابة في طبيعة الأرض؟", "a": ["الألماس", "الماس"]},
    {"q": "ما هي الدولة المفترض بها الموطن الأصلي للبيتزا؟", "a": ["إيطاليا", "ايطاليا"]},
    ...
    {"q": "ما هو الغاز الذي يستعمله النبات في البناء الضوئي؟", "a": ["ثاني أكسيد الكربون", "ثاني اكسيد الكربون"]},
    {"q": "ما هي عاصمة المغرب؟", "a": ["الرباط"]},
    {"q": "ما هي السورة التي تُسمى 'قلب القرآن'؟", "a": ["يس", "يسن"]},
    {"q": "ما هو العلم الذي يهتم بدراسة الأحافير والحيوانات القديمة؟", "a": ["الفرع الأحفوري", "الإحاثة", "علم الأحافير"]},
    ...
    {"q": "ما هو الهرمون المسؤول عن تنظيم مستوى السكر في الدم؟", "a": ["الأنسولين", "الانسولين"]},
    {"q": "ما هي عاصمة المملكة العربية السعودية؟", "a": ["الرياض"]},
    {"q": "ما هي عاصمة الصين؟", "a": ["بكين"]},
    {"q": "ما هو معدن السيولة العالية الفضي السائل في حرارة الغرفة؟", "a": ["الزئبق"]},
    ...
    {"q": "من هو مكتشف البنسلين؟", "a": ["ألكسندر فلمنج", "فلمنج", "الكسندر فلمنج"]},
    ...
    {"q": "ما هي السورة التي ذكرت فيها البسملة مرتين؟", "a": ["النمل", "سورة النمل"]},
    ...
    {"q": "ما هي السلسلة الجبلية الفاصلة بين قارتي آسيا وأوروبا؟", "a": ["أورال", "جبال الأورال"]},
    ...
    {"q": "ما هو اسم النهر الوحيد الذي يمر بالعديد من الدول الأوربية؟", "a": ["الدانوب", "نهر الدانوب"]},
    {"q": "ما هي عاصمة البرتغال؟", "a": ["لشبونة"]},
    {"q": "من هو الصحابي الجليل الملقب بـ 'ترجمان القرآن'؟", "a": ["عبدالله بن عباس", "عبد الله بن عباس"]},
    ...
    {"q": "ما هو الغاز الذي ينبعث من أشجار الغابات ليلةً؟", "a": ["ثاني أكسيد الكربون"]},
    {"q": "ما هي عاصمة قطر؟", "a": ["الدوحة"]},
]

RIDDLES = [
    {"q": "شيء كلما أخذت منه كبر، فما هو؟", "a": ["الحفرة", "حفرة"]},
    {"q": "يمشي بلا أرجل ويدخل الأذنين فقط، فما هو؟", "a": ["الصوت", "صوت"]},
    ...
    {"q": "ما هو الشيء الذي يمكنك إمساكه بدون لمسه؟", "a": ["الأعصاب", "أعصابك"]},
    {"q": "ما هو القفص الذي لا يحبس فيه طائر أو حيوان؟", "a": ["القفص الصدري"]},
    ...
    {"q": "أنا ذو ثقوب عديدة ولكني أحتفظ بالماء، فمن أنا؟", "a": ["الإسفنج", "اسفنج"]},
    {"q": "ما هو الشيء الذي إذا صببت عليه الماء لا يبتل؟", "a": ["الظل", "ظلك"]},
    {"q": "ما هو الشارع الذي لم يسير فيه أحد؟", "a": ["شارع الرسم", "الشارع على الخريطة", "الخريطة"]},
    {"q": "ما هو الشيء الذي يقرأ كل الأوراق وبلا عيون؟", "a": ["المسح الضوئي", "الضوء"]},
    {"q": "ما هو الذي يمر عبر الزجاج ولكن لا يكسره؟", "a": ["الضوء", "ضوء"]},
    {"q": "له رأس واحد وله أربعة أرجل ولكن لا يسير؟", "a": ["السرير", "سرير"]},
    {"q": "شيء يأكل ولا يشبع، وإذا شرب الماء يموت؟", "a": ["النار"]},
    {"q": "تراه في الليل ثلاث مرات وفي النهار مرة واحدة، فما هو؟", "a": ["حرف اللام"]},
    {"q": "ما هو الشيء الذي ينبض بلا قلب؟", "a": ["الساعة", "ساعة"]},
    {"q": "ما هو الباب الذي لا يمكن فتحه؟", "a": ["الباب المفتوح"]},
    {"q": "هو ابن أمك وأبيك وليس بأخيك ولا أختك، فمن هو؟", "a": ["أنت", "انت"]},
    {"q": "تكون طويلة في شبابها وقصيرة في كبر سنها، فما هي؟", "a": ["الشمعة"]},
    {"q": "ماهي الأشياء التي تسير بلا قدمين وتصيح بلا فم؟", "a": ["الرياح", "رياح"]},
    {"q": "له أسنان كثيرة ولكنه لا يعض، فما هو؟", "a": ["المشط", "مشط"]},
    {"q": "يحبها الجميع ويعطونها للآخرين ولكن لا أحد يستطيع الاحتفاظ بها؟", "a": ["الكلمة", "الوعد"]},
    {"q": "ما هو الشيء الذي تسمعه ولا تراه، وإذا رأيته لا تسمعه؟", "a": ["الطلقة النارية", "الرعد"]},
    {"q": "شيء يسير في السماء ويستريح في الأرض؟", "a": ["المطر", "مطر"]},
    {"q": "تطير بدون أجنحة وتبكي بدون عيون، فما هي؟", "a": ["السحابة", "السحاب"]},
    {"q": "ما هو الشيء الذي يحتوي على المدن ولكن ليس به بيوت؟", "a": ["الخريطة"]},
    ...
    {"q": "أسود عندما تشتريه، وأحمر عندما تستخدمه، وأبيض عندما ترميه؟", "a": ["الفحم"]},
    {"q": "ما هو الشيء الذي يجري ولكن لا يستطيع المشي؟", "a": ["الماء", "النهر"]},
    {"q": "يمتلك كل مفاتيح العالم ولكنه لا يستطيع فتح أي باب؟", "a": ["البيانو"]},
    {"q": "ما هو الشيء الذي ينكسر بمجرد تسميته؟", "a": ["الصمت"]},
    {"q": "يتحدث كل لغات العالم بدون أن يتكلم؟", "a": ["الصدى"]},
    {"q": "ما هو الشيء الذي تصنعه ولكن لا تراه؟", "a": ["الضوضاء", "الرقام"]},
    {"q": "إذا أطعمته ينمو، وإذا سقيته يموت؟", "a": ["النار"]},
    {"q": "يمتلك رقبة ولكن ليس له رأس؟", "a": ["الزجاجة", "قميص"]},
    {"q": "ما هو الذي يستطيع الضوء اختراقه والماء المضيء فيه؟", "a": ["الزجاج"]},
    {"q": "شيء بينك وبين السماء، فما هو؟", "a": ["الكاف", "حرف الكاف"]},
    {"q": "ما هو الشارع الذي يمشي فيه الناس بلا أقدام؟", "a": ["شارع الخريطة"]},
    {"q": "ما هو العضو الوحيد الذي لا يصله الدم؟", "a": ["قرنية العين", "القرنية"]},
    ...
    {"q": "يحتاج دائماً إلى إجابة ولكنه لا يطرح أي سؤال؟", "a": ["الهاتف", "الجرس"]},
    {"q": "ما هو الشيء الذي يسير أمامك ولا تستطيع الوصول إليه؟", "a": ["المستقبل"]},
    {"q": "ما هو الشيء الذي يملك أقداماً ثلاث ولا يمشي؟", "a": ["المنصة", "الطاولة"]},
    ...
    {"q": "يمتلك كل العيون ولكنه لا يرى شيئاً؟", "a": ["شاطئ البطاطس", "البطاطس"]},
    {"q": "ما هو الشهر الذي فيه 28 يوماً؟", "a": ["كل الشهور", "جميع الشهور"]},
    {"q": "ما هو أصلح شيء للرؤية في الظلام التام؟", "a": ["لا شيء"]},
    {"q": "ما هو الشيء الذي يملك ذراعين وليس لديه أصابع؟", "a": ["الكرسي"]},
    {"q": "أين يمكنك إيجاد الجمعة قبل الخميس؟", "a": ["في المعجم", "القاموس"]},
    {"q": "إذا كان هناك 3 تفاحات وأخذت 2، فكم تفاحة لديك؟", "a": ["2", "تفاحتان"]},
    {"q": "ما هو القادم الذي لا يصل أبداً؟", "a": ["غداً", "الغد"]},
    {"q": "أنا بداية النهاية ونهاية الزمان والمكان فمن أنا؟", "a": ["حرف النون"]},
    {"q": "ما هو الشيء الذي إذا غسلت به يظل متسخاً؟", "a": ["الماء"]},
    {"q": "ما هو الشيء الذي يطير بدون أجنحة ويدخل العيون بدون استئذان؟", "a": ["الغبار"]},
    {"q": "يتحرك باستمرار وبلا توقف ولكن لا يتعب؟", "a": ["القلب"]},
    {"q": "ما هي المادة التي يفرزها الجسم وتصلح لبناء العظام؟", "a": ["الكالسيوم"]},
    {"q": "ما هو الشيء الذي ينقص كلما أخذت منه أكثر؟", "a": ["الحفرة"]},
    {"q": "ما هي الشجرة التي ليس لها ظل وليس لها أوراق؟", "a": ["شجرة العائلة"]},
    {"q": "ما هو أصلح مكان لبناء بيت بدون جدران؟", "a": ["الإنترنت", "العقل"]},
    {"q": "ما هي الكلمة التي تُنطق دائماً بشكل غير صحيح؟", "a": ["غير صحيح"]},
    {"q": "يمتلك ريشاً ولكنه لا يطير ولديه أرقام فقط؟", "a": ["سهم الدرجات", "القلم"]},
    ...
    {"q": "ما هو العضو الذي يستمر في النمو طوال حياة الإنسان؟", "a": ["الأنف والأذن", "الأنف"]},
    {"q": "ما هو السؤال الذي لا يمكنك الإجابة عليه بنعم أبداً؟", "a": ["هل أنت نائم؟"]},
    {"q": "ما هي الكلمة الوحيدة في القاموس التي كُتبت خطأ؟", "a": ["خطأ"]},
    {"q": "من هو الشخص الذي يرى عدوه وصديقه بعين واحدة؟", "a": ["الأعور"]},
    {"q": "ما هو الشيء الذي لا يبتل حتى لو نزل في أغزر مياه؟", "a": ["الظل"]},
    {"q": "له أسنان عديدة لكنه لا يستطيع العض بها؟", "a": ["المشط"]},
    {"q": "يمتلك زجاجاً ولكنه ليس بنوافذ، ويتصل بالشبكة؟", "a": ["الهاتف الذكي"]},
    {"q": "ما هو الماء الذي لا يخرج من الأرض ولا ينزل من السماء؟", "a": ["العرق", "دموع العين"]},
    {"q": "من هو الشخص الذي يقتل مئات الأشخاص يومياً بدون أن يعاقبه أحد؟", "a": ["الحلاق"]},
    {"q": "ما هي العروس التي لا يراها أحد إلا زوجها؟", "a": ["عروسة اللعبة"]},
    {"q": "يمتلك شوكة واحدة وأحياناً أربعة ولا يأكل أبداً؟", "a": ["شوكة الطعام"]},
    ...
    {"q": "ما هو الشيء الذي يسير بلا أقدام ولا يرجع للخلف أبداً؟", "a": ["الوقت", "العمر"]},
